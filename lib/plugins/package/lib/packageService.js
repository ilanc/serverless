...
module.exports = {
  ...
  packageAll() {
    ...
    return this.zipService(exclude, include, zipFileName, this.options.permissions).then(filePath => {
  ...
  packageFunction(functionName) {
    ...
    return this.zipService(exclude, include, zipFileName, this.options.permissions).then(artifactPath => {
